...
const showFunctionsShowSchema = require("../schema/show_functions_shows.json");
...
const showFunctionsShowsValidator = schemaValidator.compile(showFunctionsShowSchema);
...
let showFunctionsShowsMiddleware = (request, response, next) => {
  return validationMiddleware(
    showFunctionsShowsValidator,
    request,
    response,
    next
  );
...
module.exports = { showFunctionsShowsMiddleware };
